...
* it to anything. It is the introduction of a named container into a scope. Its name or identifer must be unique, short and descriptive.
...
*/
console.log(myName); // prints => john *now that we have initialized the variable a console.log statment prints what's inside the container

// 3. RE-ASSIGNMENT //
myName = 'john'; 
/*
*Re-assignment phase takes an existing variable and it's value and gives said variable a new value. 
*Reassigned variables can be difficult to identify when working with large amounts of code so use it wisely. Include strong psuedocode. 
*
*/
...
var myVariable = 1; //variable now contians a number
...
* var, let, const:
* 
*Variables can be assigned and delcared using the keywords var, let, or const.
 ...
 *The declaration process takes place before any line of code is ran. 
...
*the let variable before it is initialize. 
*/
...
*When assigned to a value it cannot be change.
*/
