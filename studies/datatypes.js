...
* Examples of primitive data types have no object or method. Primitive data types are numbers, strings, booolean, null, undefined, and
...
/*
*A string is a collection of characters that can contain spaces and number inside of quotations.
*/
var meString = "Oh to be a String!";

// 3. Boolean //
/*
* Booleans are great with setting condtions in loops and if else conditional statements. 
...
* other arrays, numbers and other objects. Arrays have indexs or addresses that 
...
/*
*An object are a complex building block for Javascript. Primitive and reference data types can be
...
* Object are best for grouping information thats but also requires other information or values. 
*/
...
/*
*It is a useable code that will produce different results by evaluating the agruments set
...
*followed by curly brackets that containing an action to take on the parameters set. Outside
...
/* 
*Undefined is any property that initially isn't assigned. Types, values, and variable.
*/
...
* arrays and other objects. They are used to methods to perform a certain action.
*
*Simple or primitive datatypes hold the orignal value. They are atomic, immutable, and copied by value. 
*Complex or non-primitive datatypes are passed by reference and there size is indefinite. They are mutable.
*/
...
/*
*When using primitive values oringally assigned to a variables is copied to the new variable from the original.
*/
var orignal = "One and Only";
var newB = orignal; //prints "One and Only" to the console
/*
*When using or accessing a complex value such as an object we utlize the name of the data to do an action. This doesn't 
*adjust the original code. It only refers to it.
*/
function passArgs(value) {
    return "I'm still the orignal!"
}
passArgs(3);
